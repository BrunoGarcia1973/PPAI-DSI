...
public class RepositorioEmpleados {
    ...
    public RepositorioEmpleados() {
        ...
        Rol sysUser = new Rol("SISTEMA", "Usuario para operaciones del sistema."); // Rol para el empleado 'SYS'
        ...
        empleados.put("SYS", new Empleado("SYS", "Sistema", "Automatizado", "sistema@example.com", "0000000000", sysUser)); // Empleado del sistema
    }
    ...
    /**
     * Devuelve una lista con todos los empleados cargados en el repositorio.
